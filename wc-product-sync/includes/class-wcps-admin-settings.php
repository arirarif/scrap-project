    ...
    public function enqueue_assets($hook) {
        ...
        wp_localize_script('wcps-admin', 'wcps', [
            ...
            'strings' => [
                ...
                'trashing' => __('Moving to trash...', 'wc-product-sync'),
                'trash_complete' => __('All synced products moved to trash!', 'wc-product-sync'),
                'trash_error' => __('Failed to trash products!', 'wc-product-sync'),
                'confirm_trash' => __('Are you sure you want to move ALL synced products to trash? This includes all products and variations created by this plugin.', 'wc-product-sync'),
                'emptying_trash' => __('Permanently deleting...', 'wc-product-sync'),
                'empty_trash_complete' => __('Trash emptied!', 'wc-product-sync'),
                'empty_trash_error' => __('Failed to empty trash!', 'wc-product-sync'),
                'confirm_empty_trash' => __('Are you sure you want to PERMANENTLY DELETE all trashed synced products? This cannot be undone!', 'wc-product-sync'),
                'resetting_cache' => __('Resetting cache...', 'wc-product-sync'),
                'cache_reset_complete' => __('Cache reset! You can now run a fresh sync.', 'wc-product-sync'),
                'cache_reset_error' => __('Failed to reset cache!', 'wc-product-sync'),
                'confirm_reset_cache' => __('Reset sync cache? This will clear batch data and allow a fresh sync.', 'wc-product-sync'),
            ],
        ]);
    }
    ...
    private function render_status_tab() {
        ...
        <div class="wcps-status-box">
            ...
            <div class="wcps-actions">
                ...
                <button type="button" id="wcps-trash-all" class="button button-secondary" style="margin-left: 10px; background: #d63638; border-color: #d63638; color: #fff;">
                    <?php esc_html_e('Trash All Synced Products', 'wc-product-sync'); ?>
                </button>
                <button type="button" id="wcps-empty-trash" class="button button-secondary" style="margin-left: 10px; background: #1d2327; border-color: #1d2327; color: #fff;">
                    <?php esc_html_e('Empty Trash (Permanent)', 'wc-product-sync'); ?>
                </button>
                <button type="button" id="wcps-reset-cache" class="button button-secondary" style="margin-left: 10px;">
                    <?php esc_html_e('Reset Cache', 'wc-product-sync'); ?>
                </button>
